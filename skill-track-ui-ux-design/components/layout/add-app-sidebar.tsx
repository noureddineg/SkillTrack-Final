...
const navigation = [
  {
    title: "Principal",
    items: [
      { title: "Tableau de bord", href: "/admin", icon: LayoutDashboard ,roles: ["admin"]},
      { title: "Gestion Utilisateurs", href: "/users", icon:Users ,roles: ["admin"]},
      { title: "Gestion compétences", href: "/competances", icon:Award  ,roles: ["admin"]},
    ],
  },
  {
    title: "Profil",
    items: [
      { title: "Paramètres", href: "/admin/addsettings", icon: Settings ,roles: [ "admin"]},
    ],
  },
]

export function AddAppSidebar() {
